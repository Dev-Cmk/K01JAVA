...
쓰레드의 우선순위
	...
	getPriority() : 쓰레드의 우선순위를 반한할때 사용
 */
...
//		MessageSendingThread tr2 = new MessageSendingThread("첫번쨰");
//		MessageSendingThread tr3 = new MessageSendingThread("첫번쨰");
