...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		yt1.setName("첫번째쓰레드");//쓰레드의 이름지정 두번째 방법
		...
		dt.setName("난 데몬쓰레드");//독립쓰레드를 데몬쓰레드로 만들어준다.
		dt.setDaemon(true);
		dt.start();
