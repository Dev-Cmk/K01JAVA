...
class MyStatic{
	...
	사용할수 있다. 인스턴스형, 정적변수 둘다 가능.
	 */
	void instanceMethod() {
		System.out.println("intanceVar="+ instanceVar); //접근가능
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		MyStatic 클래스의 인터스턴형 멤버변수에 접근하는 방법
		-> 인스턴스 생성 후 참조변수를 통해 접근한다.
		 */
		MyStatic myStatic = new MyStatic();
		myStatic.instanceVar = 100;
		System.out.println("myStatic.instaceVar="+
